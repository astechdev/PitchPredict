...
//    jQuery("#pitchcountercontainer").load("Components/PitchCounter/pitch_counter.html", function() 
//    {
        ...
        jQuery('#pitchrecordertable').find('tbody:last').append('\
            <tr id="addrowid" class="addRow">\n\
                <td></td>\n\
                <td><div><input type="Submit" id="addpitchbutton" value="+" class="buttons" onClick="showPitchCounterInputRow()"></div><div><input type="Submit" id="removepitchbutton" value="-" class="buttons" onClick="removePitchCounterInputRow()"></div></td>\n\
                <td></td>\n\
                <td></td>\n\
                <td></td>\n\
                <td></td>\n\
...
//    });
    ...
    //setTimeout('hidePitchCounterInputRow()',400);
    //setTimeout('hideRemovePitchButton()',400);
}
