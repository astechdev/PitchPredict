...
//    alert(JSON.stringify(awayTeamMap));
    ...
    jQuery.getJSON('http://www.pitchpredict.com/PitchPredict/Services/getUserStateVariables.php?UserName='+jQuery.cookie("UserName"), function(data) 
    {
...
//        }
        ...
        params = "UserName=" + jQuery.cookie("UserName")+
