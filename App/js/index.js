...
//    jQuery('#resultscontainer').append(ifrm); 
    ...
    jQuery('#resultscontainer').prepend('<iframe height="100%" width="100%" id="results_iframe" scrolling="no" seamless="seamless" src="'+url+'"><p>Your browser does not support iframes.</p></iframe>');
}
