...
<div id="hotzone">
	...
	<table id="hotzonetable">
		<tr>
		  	<td onclick=setHotzone(zone1) background=<?php echo $aHotZoneObject->theZone1Object->theBackground?> >
				<?php 
		  	...
		  	<td onclick=setHotzone(zone2) background=<?php echo $aHotZoneObject->theZone2Object->theBackground?> >
				<?php 
		  	...
		  	<td onclick=setHotzone(zone3) background=<?php echo $aHotZoneObject->theZone3Object->theBackground?> >
				<?php 
		...
		<tr>
		  	<td onclick=setHotzone(zone4) background=<?php echo $aHotZoneObject->theZone4Object->theBackground?> >
				<?php 
		  	...
		  	<td onclick=setHotzone(zone5) background=<?php echo $aHotZoneObject->theZone5Object->theBackground?> >
				<?php 
		  	...
		  	<td onclick=setHotzone(zone6) background=<?php echo $aHotZoneObject->theZone6Object->theBackground?> >
				<?php 
		...
		<tr>
		  	<td onclick=setHotzone(zone7) background=<?php echo $aHotZoneObject->theZone7Object->theBackground?> >
				<?php 
		  	...
		  	<td onclick=setHotzone(zone8) background=<?php echo $aHotZoneObject->theZone8Object->theBackground?> >
				<?php 
		  	...
		  	<td onclick=setHotzone(zone9) background=<?php echo $aHotZoneObject->theZone9Object->theBackground?> >
				<?php 
...
<!--		<tr>
		  	<td onclick=setHotzone(zone10) background=<?php echo $aHotZoneObject->theZone10Object->theBackground?> >
				<?php 
		  	...
		  	<td onclick=setHotzone(zone11) background=<?php echo $aHotZoneObject->theZone11Object->theBackground?> >
				<?php 
		  	...
		  	<td onclick=setHotzone(zone12) background=<?php echo $aHotZoneObject->theZone12Object->theBackground?> >
				<?php 
		...
		<tr>
		  	<td onclick=setHotzone(zone13) background=<?php echo $aHotZoneObject->theZone13Object->theBackground?> >
				<?php 
		  	...
		  	<td onclick=setHotzone(zone14) background=<?php echo $aHotZoneObject->theZone14Object->theBackground?> >
				<?php 
        ...
        <?php 
                include $_SERVER['DOCUMENT_ROOT'].'/PitchPredict/Services/Results/filters.php';
        ?>
</div>