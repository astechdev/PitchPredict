function updatePitchTypePercentageChart()
{
    ...
    jQuery('#pitchtypepercentagechart').load(url);
}
...
function updateVerticalChart()
{
    ...
    jQuery('#vertmovementchart').load(url); 
    ...
    jQuery('#sidepitchvirtualizationchart').load(url);   
}
...
function updateHorizontalChart()
{
    ...
    jQuery('#horizmovementchart').load(url);    
    ...
    jQuery('#toppitchvirtualizationchart').load(url);
}
...
function updateResultsChart()
{
    ...
    jQuery('#resultspercentagechart').load(url);
}
...
function updateOutcomePercentageChart()
{
    ...
    jQuery('#outcomepercentagechart').load(url);
}
